...
def test_search_mode_text_and_element_simple():
    ...
    fr_text = extract_common_parent_html(html, "Год издания:", "2022", verbose=False, search_mode="text")
    assert len(fr_text) == 1

    # Режим element: ищем элементы по полному тексту
    fr_elem = extract_common_parent_html(html, "Год издания:", "2022", verbose=False, search_mode="element")
...
def test_search_mode_with_formatting_tags():
    ...
    fr_text2 = extract_common_parent_html(html2, "Год издания:", "2022", verbose=False, search_mode="text")
    ...
    fr_elem2 = extract_common_parent_html(html2, "Год издания:", "2022", verbose=False, search_mode="element")
